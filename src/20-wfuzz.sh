## wfuzz vhost [s(sl)|tls] [domain] [hw] [hc]^: wfuzz vhost
## wfuzz [help|s(sl)|tls] [subdir] [hw] [hc]^: wfuzz files/folders
...
if [ "$1" == "wfuzz" ]; then
  ...
  CMD="wfuzz -u '$PROTO://${RHOST}${SUB}FUZZ' -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt $HW $HC"
